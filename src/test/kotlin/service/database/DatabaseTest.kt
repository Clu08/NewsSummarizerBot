...
class DatabaseTest : StringSpec({
    ...
    val newsPiece1 = NewsPiece("link1", "Company1 is good")
    val newsPiece2 = NewsPiece("link2", "Company1 and Company3 are bad")
    ...
    database.addNewsPiece(newsPiece1.link, newsPiece1.text)
    database.addNewsPiece(newsPiece2.link, newsPiece2.text)
