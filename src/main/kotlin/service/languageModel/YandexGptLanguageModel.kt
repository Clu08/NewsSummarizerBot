                ...
                add(JsonObject().apply {
                    ...
                    addProperty(
                        ...
                        """"Вот название новости: "${newsPiece.title}".
                            ...
                            Может ли данная новость иметь положительное или отрицательное влияние на мнение инвесторов о компании "${company.name}"?
                            Основывайся исключительно на этой новости. Напиши первым словом одно число от -10 (мнение сильно изменилось в худшую) до +10 (мнение сильно изменилось в лучшую). 
                            Поставь небольшую по модулю оценку, даже если новость могла привести к изменению мнения только некоторых людей.
                            После напиши короткое объяснение своего решения. Если новость малозначимая, всё равно сформируй мнение о ней, не используя других данных о компании и рынке. Ответ напиши в одну строку."""
                    )
                })
            })
        }
